# Tatte Bakery Tarzında Bakery/Patisserie Prompt'ları
...
### Renk Paleti
- **Dominant:** Warm cream (#F5F0E8), sıcak kahverengi (#8B6914)
- **Aksent:** Altın/hardal (#D4A84B), turuncu (#FF8C00)
- **Arka plan:** Off-white, açık mermer, sıcak ahşap

### Işık
- Doğal pencere ışığı, yumuşak ve diffused
- Sıcak beyaz dengesi (warm white balance)
- Yan ışık dominant, soft gölgeler

### Kompozisyon
- %40 lifestyle (insan eli/model)
- %25 hero product shot
- %20 mekan atmosferi
- Minimal prop, temiz arka plan

### Signature Elements
- İnsan elleri ürünü tutuyor/süslüyor
- Siyah-beyaz checkered zemin (opsiyonel)
- Krem/beyaz seramik tabaklar
- Kraft kağıt, keten kumaş proplar

---

## CROISSANT PROMPT'LARI
...
for Instagram, warm color grading with cream and golden tones, editorial food photography,
the croissant showing beautiful lamination layers, cozy and inviting atmosphere,
mobile-optimized composition with subject centered
```
...
ratio for Instagram, golden flaky layers visible, melted chocolate visible, inviting
breakfast scene, lifestyle food photography, mobile-optimized framing
```
...
for Instagram, warm Mediterranean color palette, gathering and sharing moment,
lifestyle food photography, mobile-optimized flat lay composition
```

---

## SEASONAL PROMPT'LARI
...
## NEGATIVE PROMPT (Kaçınılacak Öğeler)

```
steam, smoke, vapor, mist effects, cold blue lighting, harsh shadows, plastic props,
artificial looking food, overly saturated colors, cluttered composition, commercial
...
## PROMPT YAZIM İPUÇLARI

### Tatte Stilini Yakalamak İçin Anahtar Kelimeler
- "warm natural light" / "window light"
- "feminine hands" / "human touch"
- "cream and warm tones" / "golden highlights"
- "shallow depth of field"
- "lifestyle food photography"
- "cozy café atmosphere"
- "artisan quality" / "handcrafted"
- "editorial style"
- "inviting and welcoming"

### Kaçınılması Gereken Kelimeler
- "studio lighting" (soğuk his)
- "perfect" / "flawless" (çok yapay)
- "bright white background" (steril)
- "commercial" (korporat his)
- "centered composition" (çok formal)

---

## UYGULANABILIR TEKNİKLER

### Tatte'den Öğrenilen Görsel Stratejiler

1. **Human Touch Kuralı**
   - Her 2-3 görselden biri insan elementi içermeli
   - El, kol, siluet yeterli (yüz şart değil)
   - Doğal pozlar, "candid" his

2. **Warm Grading**
   - Tüm görsellerde tutarlı sıcak ton
   - Beyazlar krem/off-white
   - Gölgeler kahverengiye çalar (maviye değil)

3. **Minimal Prop Felsefesi**
   - 1-2 prop yeterli
   - Doğal malzemeler (ahşap, keten, seramik)
   - Prop ürünü gölgede bırakmamalı

4. **Işık Tutarlılığı**
   - Doğal ışık tercihi
   - Yan veya 45° açı
   - Yumuşak, diffused karakter

5. **Storytelling Yaklaşımı**
   - Her görsel bir "an" yakalamalı
   - Hareket/aksiyon önerisi (tutma, kesme, servis)
   - Yaşanmış his ("lived-in" aesthetic)

---

## KAÇINILMASI GEREKENLER

### Bu Markaya Özgü, Kopyalanmaması Gereken Öğeler

1. **Siyah-beyaz checkered zemin** - Tatte'nin signature elementi
2. **"Gathering around" sloganı** - Marka tescilli
3. **Shakshuka sunumu** - Tatte'nin imza yemeği
4. **Spesifik mekan görünümleri** - Telif hakkı riski
5. **Çalışan uniformaları** - Marka kimliği

### Yerine Kullanılabilecek Alternatifler

| Tatte Elementi | Alternatif |
|----------------|------------|
| Checkered zemin | Düz mermer veya ahşap |
| Shakshuka | Diğer Mediterranean yemekler |
| Tatte logosu | Jenerik bakery elementleri |
| Spesifik lokasyon | Genel café atmosferi |
