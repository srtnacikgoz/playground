...
**Tablet Çikolata Yatay Tekrar Dizilimi Promptu**

Tüm tablet çikolata ürünleri için universal horizontal array prompt. Referans görselinizle birlikte kullanın - AI pattern/renk/texture'ı referanstan öğrenir.

**Platform:** DALL-E 3 (Önerilen) | Gemini (Backup)
**Konsept:** Repetition array - identical bars in rhythmic horizontal sequence
...
| Özellik | Değer |
|---------|-------|
| Framing | Full product row |
| Arrangement | 5 identical bars, horizontal |
| Spacing | Even, consistent |
| Angle | Subtle matching angle per bar |
| Lighting | High-key, soft diffused |
| Background | Soft off-white, 3% texture |
| Mood | Minimalist, commercial, premium |
